...
class AdminController extends Controller
{
    ...
    public function getApprovedLoan(){
        ...
        ))->orderBy('applied_on','desc')->get();
        return view('admin.application')->with(array('loan' => $validResponse,'msg' => 'Approved Loan'));
    ...
    public function getPendingLoan(){
        ...
        return view('admin.application')->with(array('loan' => $validResponse,'msg' => 'Pending Loan'));
    ...
    public function getRejectedLoan(){
        ...
        return view('admin.application')->with(array('loan' => $validResponse,'msg' => 'Rejected Loan'));
