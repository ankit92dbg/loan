...
class ApiController extends Controller
{
    ...
    public function registerUser(Request $request){
        $validator = Validator::make($request->all(), [
            ...
            'martial_status' => 'required|in:0,1,2',
            ...
            'pan_back' => ['required', 'max:255','mimes:pdf,jpeg,jpg|max:5120'],
        ...
        if ($validator->fails()) {
            ...
            try {
               ...
               // $user->aadhar_back = $request->aadhar_back;
                ...
                $file_pan_back_original_name = $request->pan_back->getClientOriginalName();
                $user->pan_back = Storage::disk('local')->putFileAs('Pan', $request->pan_back, $file_pan_back_original_name);
