                    ...
                    <div class="row">
                     ...
                     <div class="row">
                       <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="identification_number" maxlength="100" value="" placeholder="Enter Inspection Number " required>
                          @error('number')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                       ...
                       <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="entity" maxlength="100" value="" placeholder="Enter Entity" required>
                          @error('entity')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                     ...
                     <div class="row">
                       <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="reference" maxlength="100" value="" placeholder="Enter Inspection Name " required>
                          @error('reference')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                       ...
                       <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="classification" maxlength="100" value="" placeholder="Enter Inspection Name " required>
